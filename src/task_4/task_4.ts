...
const savingService = new SavingsAccount()
const checkingService = new CheckingAccount()
const loanService = new LoanAccount()
savingService.deposit(200)
checkingService.withdraw(100)
loanService.loanRequest(50)